	...
	if ( !taxonomy_exists( 'prominence' ) ) {
		register_taxonomy(
			...
			array(
				'hierarchical'  => true,
				'labels'        => array(
				    'name'                  => _x( 'Post Prominence', 'taxonomy-general-name', 'largo' ),
				    'singular_name'         => _x( 'Post Prominence', 'taxonomy-singular-name', 'largo' ),
				    'search_items'          => __( 'Search Post Prominences', 'largo' ),
				    'all_items'             => __( 'All Post Prominences', 'largo' ),
				    'parent_item'           => __( 'Parent Post Prominence', 'largo' ),
				    'parent_item_colon'     => __( 'Parent Post Prominence:', 'largo' ),
				    'edit_item'             => __( 'Edit Post Prominence', 'largo' ),
				    'view_item'             => __( 'View Post Prominence', 'largo' ),
				    'update_item'           => __( 'Update Post Prominence', 'largo' ),
				    'add_new_item'          => __( 'Add New Post Prominence', 'largo' ),
				    'new_item_name'         => __( 'New Post Prominence Name', 'largo' ),
				    'menu_name'             => __( 'Post Prominence', 'largo' ),
				    'not_found'             => __( 'No post prominences found.', 'largo' ),
				    'no_terms'              => __( 'No post prominences', 'largo' ),
				    'items_list_navigation' => __( 'Post Prominences list navigation', 'largo' ),
				    'items_list'            => __( 'Post Prominences list', 'largo' ),
				    'back_to_items'         => __( '&larr; Back to Post Prominences', 'largo' )
				),
				'query_var'     => true,
				'rewrite'       => true,
				'show_in_rest'  => true,
		...
		register_taxonomy(
			...
			array(
				...
				'labels' => array(
				    ...
				    'search_items'          => __( 'Search Post Type', 'largo' ),
				    'parent_item'           => __( 'Parent Post Types', 'largo' ),
				    'parent_item_colon'     => __( 'Parent Post Types:', 'largo' ),
				    'not_found'             => __( 'No post types found.', 'largo' ),
				    'no_terms'              => __( 'No post types', 'largo' ),
				    'items_list_navigation' => __( 'Post Types list navigation', 'largo' ),
				    'items_list'            => __( 'Post Types list', 'largo' ),
				    'back_to_items'         => __( '&larr; Back to Post Types', 'largo' )
				),
				'public' => $enabled,
	...
	if ( ! taxonomy_exists( 'series' ) ) {
		...
		register_taxonomy(
			...
			array(
				'hierarchical' => true,
				'labels' => array(
				    'name'                  => _x( 'Series', 'taxonomy-general-name', 'largo' ),
				    'singular_name'         => _x( 'Series', 'taxonomy-singular-name', 'largo' ),
				    'search_items'          => __( 'Search Series', 'largo' ),
				    'all_items'             => __( 'All Series', 'largo' ),
				    'parent_item'           => __( 'Parent Series', 'largo' ),
				    'parent_item_colon'     => __( 'Parent Series:', 'largo' ),
				    'edit_item'             => __( 'Edit Series', 'largo' ),
				    'view_item'             => __( 'View Series', 'largo' ),
				    'update_item'           => __( 'Update Series', 'largo' ),
				    'add_new_item'          => __( 'Add New Series', 'largo' ),
				    'new_item_name'         => __( 'New Series Name', 'largo' ),
				    'menu_name'             => __( 'Series', 'largo' ),
				    'not_found'             => __( 'No series found.', 'largo' ),
				    'no_terms'              => __( 'No series', 'largo' ),
				    'items_list_navigation' => __( 'Series list navigation', 'largo' ),
				    'items_list'            => __( 'Series list', 'largo' ),
				    'back_to_items'         => __( '&larr; Back to Series', 'largo' )
				),
