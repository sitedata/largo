...
- Theme Options > Theme Images tab was using deprecated javascript/jQuery function `.live()`. Updated file `lib/options-framework/js/of-medialibrary-uploader.js`. [Pull request #1888](https://github.com/WPBuddy/largo/pull/1888) for [issue #1874](https://github.com/WPBuddy/largo/issues/1874).
