...
- Fixes issue where floating social buttons were not clickable, because of z-index ordering. [Pull request ]() for [issue #1576](https://github.com/INN/largo/issues/1576).
- Fixes links in social media buttons not respecting the blog's character set. [Pull request #]() for [issue #1283](https://github.com/INN/largo/issues/1283).
- Function `largo_post_social_links` now respects the blog character set option. [Pull request #]() for [issue #1283](https://github.com/INN/largo/issues/1283).
