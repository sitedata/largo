...
- The arguments set on `largo_byline()` are now passed to the `largo_byline` filter as an array of argument name => argument value. [Pull request #]() for [issue #1646](https://github.com/INN/largo/issues/1656).
