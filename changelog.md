...
- Implode() function args out of order on line 174 of post-social.php causing fatal error on all single post pages [Pull Request](https://github.com/WPBuddy/largo/pull/1887) for issue [#1885](https://github.com/WPBuddy/largo/issues/1885)
