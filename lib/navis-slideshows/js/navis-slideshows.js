            ...
            if ( img[0].hasAttribute('src') ){
                ...
                img.click(function(){
                    ...
                    if(gallery.closest('.wp-block-columns').hasClass('alignfull')){
                        $(gallery).closest('.wp-block-columns').removeClass('alignfull');
                        var gallery_parent_alignfull = true;
                    }
                    ...
                    if (gallery[0].localName !== "a"){
                        ...
                        $('.navis-single .navis-before').click(function(){
                            ...
                            // let's restore that class on lightbox exit
                            if(gallery_parent_alignfull){
                                $(gallery).closest('.wp-block-columns').addClass('alignfull');
                            }
